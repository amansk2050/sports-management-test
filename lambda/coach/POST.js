...
//------------function to insert coach-------
function insert_coach(result) {
  console.log("inside insert_coach function ");
  return new Promise(async (resolve, reject) => {
    try {
      if (typeof result == "string") {
        result = JSON.parse(result);
      }
      var insert = `insert into coach(coach_name)
      values('${result.coach_name}')`;
